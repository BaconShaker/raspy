 ...
 *
 * The redundant addresses as the Register CANSTAT 
 * (0x0E, 0x1E, 0x2E, ...) were not listed with.
 */
/*@{*/
...
/** \name	Bit definition of the various registers */
/*@{*/
 ...
 * \see		RXM1, RXM0, RXRTR und FILHIT0 are already defined for RXB0CTRL
 */
#define FILHIT2		2
#define FILHIT1		1
